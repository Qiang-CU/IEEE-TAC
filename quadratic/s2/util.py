...
def creat_mixing_matrix(num_agent, graph_type, self_weight):
    if graph_type == 'RingGraph':
        ...
        g = nx.erdos_renyi_graph(num_agent, p=np.log(num_agent)/num_agent, seed=123)
        while not nx.is_connected(g):
            g = nx.erdos_renyi_graph(num_agent, p=np.log(num_agent)/num_agent)
